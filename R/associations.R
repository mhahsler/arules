...
#' @aliases items<-
setMethod(
  "items", signature(x = "associations"),
  function(x) {
...
setMethod(
  "length", signature(x = "associations"),
  function(x) {
...
setMethod(
  "labels", signature(object = "associations"),
  function(object) {
    stop(paste(
