...
setMethod(
  "show", signature(object = "summary.transactions"),
  function(object) {
    cat("transactions as ")
...
setMethod(
  "toLongFormat", signature(from = "transactions"),
  function(
      from,
      cols = c("TID", "item"),
      decode = TRUE) {
...
setMethod(
  "items", signature(x = "transactions"),
  function(x) {
    as(x, "itemMatrix")
  }
)
...
setMethod(
  "transactionInfo", signature(x = "transactions"),
  function(x) {
    x@itemsetInfo
  }
)
...
setMethod(
  "dimnames", signature(x = "transactions"),
  function(x) {
