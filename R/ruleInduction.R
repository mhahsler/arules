...
#' which can be generated by the given set of [itemsets] from a [transactions]
#' dataset. This method can be used to create closed association [rules].
#'
...
#' rules are mined from the transactions data set using [apriori()] with the
...
#'
#' `ruleInduction()` can be used to produce closed association rules defined by Pei
...
#' @param confidence a numeric value giving the minimum confidence for the
#' rules.
