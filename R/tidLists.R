...
setMethod(
  "show", signature(object = "summary.tidLists"),
  function(object) {
    cat(
      "tidLists in sparse format with\n",
      object@Dim[1],
...
setMethod(
  "transactionInfo", signature(x = "tidLists"),
  function(x) {
    x@transactionInfo
  }
)
...
setMethod(
  "itemInfo", signature(object = "tidLists"),
  function(object) {
    object@itemInfo
  }
)
...
setMethod(
  "itemLabels", signature(object = "tidLists"),
  function(object) {
    rownames(object)
  }
)
...
setMethod(
  "labels", signature(object = "tidLists"),
  function(object) {
    sapply(
      as(object, "list"),
      function(x) {
